...
class Algorithm {
public:
    Algorithm( i64 n, i64 H, const vi64& h, const vi64& s ):
        n( n ),
        H( H ),
        h( h ),
        s( s )
...
int main() {
    ...
    if( 0 ){
        ...
        auto H = load_scalar<i64>();
        auto h = load_vector<i64>( n );
        auto s = load_vector<i64>( n );
        Algorithm( n, H, h, s ).pusk();
    }
}
////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////
