...
//
// [ Input ]
// The first input line contains two integers n and q:
// the number of nodes and queries. The nodes are
// numbered 1,2,...,n.
...
// queries. Each line contains two integer a and b:
