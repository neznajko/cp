...
private:
    ...
    vi64 tree; // 二分 インデックス 木
    
    i64 p( i64 k ){ // だいいち　ビット
        return k & -k;
    }
...
public:
        ...
        tree( vi64( n + 1 ))
    {
        ...
        For( k, 1, n + 1 ){
            ...
            //        - - - -
            //        - - - - - - - -            
            tree[ k ] = pref[ k ] - pref[ k - p( k )];
            // tree = [0,3,5,4,14,1,2,5,24]
        }
        dbg( tree );
    }
    void pusk() {
