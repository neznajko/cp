...
class Algorithm {
public:
    Algorithm( u64 a, u64 b, u64 c ):
        a( a ),
        b( b ),
        c( c )
    {}
    void pusk(){
        dmp( modexp( a, modexp( b, c, mod1 - 1 ), mod1 ));
    }
private:
    u64 a;
    u64 b;
    u64 c;
    u64 modexp( u64 x, u64 y, u64 m ){
        if( y == 0 ){ return 1; }
        u64 z = modexp( x, y / 2, m );
        u64 w = z * z % m;
        return evn( y ) ? w : w * x % m;
    }
};
////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////
...
int main() {
    ...
    if( 0 ){
        ...
        FOR_THE_HORDE {
            auto a = load_scalar<u64>();
            auto b = load_scalar<u64>();
            auto c = load_scalar<u64>();
            Algorithm( a, b, c ).pusk();
        }
    }
}
////////////////////////////////////////////////////////////////
