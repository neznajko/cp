...
public:
    ...
    friend ostream& operator<<( ostream& os, const Deque& deq ){
        os << "[ ";
        For( j, deq.head, deq.tail ){
            os << deq.bufr[j] << sp;
        }
        return os << "]";
    }
private:
    static const i32 CAP = 1'000'000;
    v<pi32> bufr = v<pi32>( CAP );
    i32 head = 0;
    i32 tail = 0;
};
////////////////////////////////////////////////////////////////
