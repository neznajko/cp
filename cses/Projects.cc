...
class Algorithm {
public:
    Algorithm( const vi64& a, const vi64& b, vi64& p ):
        a( a ), b( b ), p( p )
    {}
    void pusk() {
        const i64 n = siz( a );
        auto q = vi64( n );
        For( i, 0, n ){ q[i] = i; }
        sort( on( q ), [&b = this->b]( auto i, auto j ){
            return (b[i] < b[j]);
        });
        auto f = vi64( n );
        auto i = q.front();
...
////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////
// 2. (a) Verify that 2⁵ - 1 and 2⁷ - 1 are prime.
//    (b) Show that 2¹¹ - 1 is not prime
// (a) 2⁵ - 1 = 31, √31 = 5; 31/{2,3,5} = {}
//     2⁷ - 1 = 127, √127 = 11; 127/{2,3,5,7,11} = {}
// (b) 2¹¹ - 1 = 2047, √2047 = 45; 2047/23 = 89 

