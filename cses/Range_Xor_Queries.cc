...
////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////
inline bool ryte( u32 a ){ return a & 1; }
inline bool left( u32 b ){ return !ryte( b );}
////////////////////////////////////////////////////////////////
u32 round_up( u32 n ){ // n > 0
    // n は ２のべき乗 です。
    if(!(n & (n - 1))){ return n; }
    return 1 << ( 32 - __builtin_clz( n ));
}
////////////////////////////////////////////////////////////////
// tree = [0,6,0,6,1,1,0,6,3,2,4,5,1,1,5,3]
//               000
//                 0
//               110
//                 6
...
private:
    ...
    void make_segment_tree( vu32& y ){
        n = round_up( siz( y ));
        tree = vu32( 2*n );
        copy( on( y ), tree.begin() + n );
        for( u32 j = siz( tree ) - 1; j > 1; j -= 2 ){
            tree[ j/2 ] = tree[ j ] ^ tree[ j - 1 ];
        }}
    u32 range_xor( u32 a, u32 b ){
        u32 x = 0;
        a += n;
        b += n;
        while( a <= b ){
...
public:
    Algorithm( vu32& y, v<pu32>& _q ): q(_q )
    {
        make_segment_tree( y );
        dbg3( n, tree, q );
    }
...
int main() {
    ...
    if( 0 ){
        ...
        auto y = load_vector <u32> (  n );
        auto q = load_vector <pu32> ( m );
        Algorithm( y, q ).pusk();
    }}
////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////
