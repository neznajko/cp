...
private:
    ...
    i64 U1( i64 u ){ return u + 1; }
    i64 V1( i64 v ){ return v + n + 1; }
    i64 U( i64 u1 ){ return u1 - 1; }
    i64 V( i64 v1 ){ return v1 - n - 1; }
public:
    Algorithm( i64 n, i64 m, v<pi64>& e ):
        n( n ), m( m ), e( e ),
        N( n + m + 2 ),
        adj( w<i64>( N + 1 )),
        cap( w<i64>( N + 1, vi64( N + 1 ))),
        prev( vi64( N + 1 ))
    {
        dbg3( n, m, e );
        // 1 -> boys
...
int main() {
    ...
    if( 0 ){
        ...
        auto e = load_vector<pi64>( k );
        sort( on( e )); e.erase( unique( on( e )), e.end());
        Algorithm( n, m, e ).pusk();
    }
}
////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////
