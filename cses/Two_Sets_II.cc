...
////////////////////////////////////////////////////////////////
// (a,b) = xa + yb
// (a,b) = (b,a%b) = x'b + y'(a%b) = x'b + y'(a - [a/b]b) =
//       = y'a + (x' - y'[a/b])b; zo | x = y'
//                                   | y = x' - y'[a/b]
pi64 ee( i64 a, i64 b ){ // ignore (a,b), return only {x,y}
    if( b == 0 ){ return { 1, 0 }; }
    auto [x,y] = ee( b, a % b );
    return { y, x - y * (a / b) };
}
////////////////////////////////////////////////////////////////
i64 invmod( i64 a ){// (a,mod1) = 1 = xa + ymod1
    auto [x,_] = ee( a, mod1 );
    if( x < 0 ) x += mod1;
    return x % mod1;
}
